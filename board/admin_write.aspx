<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="admin_write.aspx.cs" Inherits="SeowoncarASP.board.admin_write" %>
            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <asp:TextBox ID="txtMANUFACTURER" runat="server" CssClass ="input--style-6" placeholder="현대"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file_cv" id="file1">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file_cv" id="file2">
                                    <label class="label--file" for="file2">Choose file</label>
                                    <span class="input-file__info">No file chosen</span>
                                </div>
                                <!--<div class="label--desc">이미지 사이즈가 크면 자동조절됨(아직안됨)</div>-->
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file_cv" id="file3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file_cv" id="file4">
                                    <label class="label--file" for="file4">Choose file</label>
                                    <span class="input-file__info">No file chosen</span>
                                </div>
                                <!--<div class="label--desc">이미지 사이즈가 크면 자동조절됨(아직안됨)</div>-->
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file_cv" id="file5">
                                    <label class="label--file" for="file5">Choose file</label>
                                    <span class="input-file__info">No file chosen</span>
                                </div>
                                <!--<div class="label--desc">이미지 사이즈가 크면 자동조절됨(아직안됨)</div>-->
                            </div>
